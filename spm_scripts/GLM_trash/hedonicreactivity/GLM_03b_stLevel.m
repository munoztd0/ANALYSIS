function GLM_03b_stLevel(subID) %whatcha

% HEDONIC

% durations =1
% Simplified model on ONSETs (STARTTRIAL, 3*odor + 2*questions liking&int)
...
name_ana = 'GLM-03b'; % output folder for this analysis
...
subj       =  subID; %{'03'};%'02';'03';'04';'05';'06';'07';'09';'10';'11';'12';'13';'14';'15';'16';'17';'18';'20';'21';'22';'23';'24';'25';'26';}; %subID;
...
% 
    ...
    %% R-N * 2 mod
        ...
        % con5 
        Ctnames{5} = 'reward_int-neutral_int'; 
        weightPos  = ismember(conditionName, {'task-hed.rewardxintensity^1'}) * 1; %
        weightNeg  = ismember(conditionName, {'task-hed.neutralxintensity^1'})* -1;
        ...
        % con6
        Ctnames{6} = 'Odor_int-NoOdor';
        weightPos  = ismember(conditionName, {'task-hed.rewardxintensity^1', 'task-hed.neutralxintensity^1'}) * 1; 
        weightNeg  = ismember(conditionName, {'task-hed.control'}) * -2;
