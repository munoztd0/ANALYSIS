...
name_ana = 'GLM-02a'; % output folder for this analysis
...
subj       =  {'02';'03';'04';'05';'06';'07';'09';'10';'11';'12';'13';'14';'15';'16';'17';'18';'20';'21';'22';'23';'24';'25';'26';}; %subID;
...
%         
%         % con6
%         Ctnames{6} = 'Odor_lik-NoOdor';
%         weightPos  = ismember(conditionName, {'task-hed.rewardxliking^1', 'task-hed.neutralxliking^1'}) * 1; 
%         weightNeg  = ismember(conditionName, {'task-hed.control'}) * -2;
