...
qsub -o /home/REWOD/ClusterOutput -j oe -l walltime=1:00:00,pmem=2GB -M david.munoz@etu.unige.ch -m e -q queue1 -N HED_GLM-03b_ttests -F " ${codeDir} ${matlab_script}" ${matlabSubmit}
