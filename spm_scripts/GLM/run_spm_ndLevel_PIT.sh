...
matlab_script="GLM_02_ndLevel"
matlabSubmit="/home/REWOD/ANALYSIS/spm_scripts/matlab_oneScript.sh"

qsub -o /home/REWOD/ClusterOutput -j oe -l walltime=1:00:00,pmem=2GB -M david.munoz@etu.unige.ch -m e -q queue1 -N PIT_GLM-02_2ndlevel-${subj} -F " ${codeDir} ${matlab_script}" ${matlabSubmit}
