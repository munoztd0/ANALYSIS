...
matlab_script="GLM_03a_ndLevel"
matlabSubmit="/home/REWOD/ANALYSIS/spm_scripts/matlab_oneScript.sh"

qsub -o /home/REWOD/ClusterOutput -j oe -l walltime=0:20:00,pmem=2GB -M david.munoz@etu.unige.ch -m e -q queue1 -N HED_GLM-03a_ttests -F " ${codeDir} ${matlab_script}" ${matlabSubmit}
