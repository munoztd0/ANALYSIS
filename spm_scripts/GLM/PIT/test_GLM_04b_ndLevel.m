...
% with covariate MEAN CENTER (before check for folder group covariate)
% PIT
...
if do_covariate
    ...
    covariateNames = {'CSp-CSm_effort_meancent' %1
        'CSp-Baseline_effort_meancent' %2
        'CSm-Baseline_effort_meancent'%3
        'CSp-CSm&Baseline_effort_meancent'}; %4
