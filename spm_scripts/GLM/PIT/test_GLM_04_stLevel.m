...
subj       =  {'11';'12';'13';'14';'15';'16';'17';'18';'20';'21';'22';'23';'24';'25';'26';}; %subID; '01'; '02';'03';'04';'05';'06';'07';'09';'10'};%
param.task = {'PIT'};
...
for i = 1:length(param.task)
    ...
    param.onset{i} = {'ONS.onsets.CS.CSp',...%1
        ...
        'ONS.onsets.CS.REM',...%4
        'ONS.onsets.CS.PE',...%5
        'ONS.onsets.grips.PIT',...%6
        'ONS.onsets.grips.REM',...%7
        'ONS.onsets.grips.PE'};%8
...
%% function section
    ...
    function [] = doContrasts(subjoutdir, param, SPM)
        ...
        % con4
        Ctnames{4} = 'CSp-CSm&Baseline'; %sum to 1 right?
