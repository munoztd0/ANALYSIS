%function GLM_03b_stLevel(subID) 
...
% 3b check with orth commentend out
% 3c is with orth = 1
...
name_ana = 'GLM-03c'; % output folder for this analysis
...
subj       =  subID; %{'01'; %'02';'03';'04';'05';'06';'07';'09';'10';'11';'12';'13';'14';'15';'16';'17';'18';'20';'21';'22';'23';'24';'25';'26';}; 
param.task = {'hedonic'}; 
        ...
        for ses = 1:ntask
            ...
            for cc=1:nconds
                ...
                if ~ std(eval(param.onset{ses}{cc}))== 0 % only if the onsets are not all 0
                    ...
                    SPM.Sess(ses).U(c).P(1).orth = 1; %!! no ortho BUT be careful
