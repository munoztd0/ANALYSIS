...
outDir=/home/OBIWAN/DATA/STUDY/DERIVED/ICA_ANTS/sub-${subjectID}/ses-second/func/
...
fslreorient2std ${dataDir}ses-second/func/*task-${taskID}_run-01_bold.nii.gz ${outDir}sub-${subjectID}_ses-second_task-${taskID}_run-01_bold_reoriented
##fslreorient2std ${dataDir}RUN_${runID}/NIFTI/*nii.gz ${outDir}RUN_${runID}_reoriented
bet ${outDir}sub-${subjectID}_ses-second_task-${taskID}_run-01_bold_reoriented ${outDir}sub-${subjectID}_ses-second_task-${taskID}_run-01_bold_reoriented_brain -f 0.25 -R
